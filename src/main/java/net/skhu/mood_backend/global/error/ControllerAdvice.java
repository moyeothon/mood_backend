package net.skhu.mood_backend.global.error;

import java.util.Objects;
import lombok.extern.slf4j.Slf4j;
import net.skhu.mood_backend.global.error.dto.ErrorResponse;
import net.skhu.mood_backend.global.error.exception.AccessDeniedGroupException;
import net.skhu.mood_backend.global.error.exception.AuthGroupException;
import net.skhu.mood_backend.global.error.exception.InvalidGroupException;
